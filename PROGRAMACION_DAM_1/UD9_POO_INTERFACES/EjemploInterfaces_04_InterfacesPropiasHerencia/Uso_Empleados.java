...
public class Uso_Empleados {
	...
	public static void main(String[] args) {
		...
		//no es valido para Empleados[] ya que esto lo implementa jefatura, no empleados. Si queremos cambiarlo, tenemos que modificar empleado
		
		
		System.out.println("el jefe "+jefeRRHH.getNombre() +"tiene un bonus de "+jefeRRHH.estableceBonus(500));
		
		//si tuvieramos el setsueldo podriamos actualizar. 
