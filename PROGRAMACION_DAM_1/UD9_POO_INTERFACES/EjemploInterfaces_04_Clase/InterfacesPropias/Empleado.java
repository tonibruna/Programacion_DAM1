...
public class Empleado implements Comparable, Trabajadores{
	...
	*/
		...
		public double estableceBonus (double grat) {
			//los empleados tienen el bonus base mas la gratificacion por productividad
			System.out.println("Este empleado NO TIENE PRIMA");
			return Trabajadores.bonus_base+grat;
		}
}
