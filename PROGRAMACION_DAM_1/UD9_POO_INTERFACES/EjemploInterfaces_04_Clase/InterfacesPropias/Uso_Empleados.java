...
public class Uso_Empleados {
	...
	public static void main(String[] args) {
		...
		//----------------------------------------
		//		EJEMPLO METODO INTERFAZ JEFES
		System.out.println(jefeRRHH.tomarDecisiones("dar mas vacaciones"));
		
		System.out.println(misEmpleados[4].tomarDecisiones("dar vacaciones en programacion"));
		
		//------------------------------------------
		
		
		//-------------------------------------
		//		EJEMPLO DE INTERFAZ TRABAJADORES
		
		System.out.println(misEmpleados[1].estableceBonus(300));
		System.out.println(misEmpleados[4].estableceBonus(3000));
		
		//---------------------------------------------
		
		
		//------------------------------------
		//		EJEMPLO DE METODO. PR07
