...
public class UsoCola {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (num) {
			case 1:
				System.out.println("Hay "+colas.getNumElemnetos()+" elementos en la lista");break;
			case 2: 	
				System.out.println("Introduce numero: ");
				numero = teclado.nextInt();
				colas.insertar(numero);break;
			case 3: 	
				colas.eliminar();break;
			case 4: 
				System.out.println("Introduce numero: ");
				numero = teclado.nextInt();
				posiciones=colas.buscarNumero(numero);
