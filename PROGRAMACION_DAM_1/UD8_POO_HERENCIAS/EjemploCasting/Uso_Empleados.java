...
public class Uso_Empleados {
	...
	public static void main(String[] args) {
		...
		double num1=7.5;      //Casting es convertir un valor doble en un int
		int num2=(int)num1;
		
		
		Empleado e1= new Empleado("Paqui Garcia", 85000, 2008,02,04);
		Jefatura j2=(Jefatura) e1;   //Aqui convertimos un valor Empleado en una Jefatura
