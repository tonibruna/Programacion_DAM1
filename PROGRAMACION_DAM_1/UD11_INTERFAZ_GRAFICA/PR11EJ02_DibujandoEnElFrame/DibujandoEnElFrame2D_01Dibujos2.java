...
public class DibujandoEnElFrame2D_01Dibujos2 {

	public static void main(String[] args) {
		// TODO Apéndice de método generado automáticamente
		MarcoConDibujo2DC m=new MarcoConDibujo2DC();
		
	}

}

class MarcoConDibujo2DC extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public MarcoConDibujo2DC () {
		
		setTitle ("preuba de dibujo");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setSize (400,400);
		LaminaConFiguras2DC milamina =new LaminaConFiguras2DC();
		add(milamina);
		setVisible(true);
	}
}

class LaminaConFiguras2DC extends JPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
